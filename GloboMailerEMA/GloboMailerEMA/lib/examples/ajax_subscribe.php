...
if ($isAjaxRequest && !empty($_POST)) {
    ...
    $listUid    = 'YOUR-LIST-ID';// you'll take this from your customers area, in list overview from the address bar.
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="http://apps.globomailer.com/sdk/backend/assets/css/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="http://apps.globomailer.com/sdk/backend/assets/css/bootstrap-glyphicons.css" />
    <link rel="stylesheet" type="text/css" href="http://apps.globomailer.com/sdk/backend/assets/css/style.css" />
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script type="text/javascript" src="http://apps.globomailer.com/sdk/backend/assets/js/bootstrap.js" id="script-bootstrap"></script>
    <link rel="shortcut icon" href="http://apps.globomailer.com/favicon.ico" type="image/x-icon" />
...
<div class="col-lg-4" id="content">
    <!--
    The form below is generated by GloboMailer EMA.
