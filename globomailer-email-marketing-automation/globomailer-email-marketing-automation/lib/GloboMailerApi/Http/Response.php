<?php
/**
 * This file contains the GloboMailerApi_Http_Response class used in the GloboMailerApi PHP-SDK.
 * 
...
/**
 * GloboMailerApi_Http_Response is the class used to get the responses back from the API endpoints.
 * 
 * @author Incite Minds Ltd <support@globosupport.com>
 ...
 * @since 1.0
 */
class GloboMailerApi_Http_Response extends GloboMailerApi_Base
{
    /**
    ...
    /**
     * @var GloboMailerApi_Params $headers the headers that came back in the response.
     */
    public $headers;
    ...
    /**
     * @var GloboMailerApi_Params $curlInfo the curl info returned in the response.
     */
    public $curlInfo;
    
    /**
     * @var GloboMailerApi_Params $body the body of the response.
     */
    public $body;
    ...
    /**
     * @var GloboMailerApi_Http_Request
     */
    public $request;
     ...
     * Contructor.
     * 
     * @param GloboMailerApi_Http_Request $request
     */
    public function __construct(GloboMailerApi_Http_Request $request)
    {
    ...
    public function populate(array $params = array())
    {
        if ($this->storeCurlInfo) {
            $this->curlInfo = new GloboMailerApi_Params($params);
        }
