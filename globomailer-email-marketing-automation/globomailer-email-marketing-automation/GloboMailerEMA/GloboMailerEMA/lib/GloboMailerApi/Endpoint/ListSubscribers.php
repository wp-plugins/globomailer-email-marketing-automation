<?php
/**
 * This file contains the lists subscribers endpoint for GloboMailerApi PHP-SDK.
 * 
...
/**
 * GloboMailerApi_Endpoint_ListSubscribers handles all the API calls for lists subscribers.
 * 
 * @author Incite Minds Ltd <support@globosupport.com>
 ...
 * @since 1.0
 */
class GloboMailerApi_Endpoint_ListSubscribers extends GloboMailerApi_Base
{
    /**
