...
/**
 * GloboMailerApi_ParamsIterator implements an interator for {@link GloboMailerApi_Params}.
 *
 * It allows GloboMailerApi_Params to return a new iterator for traversing the items in the map.
 * 
 ...
 */
class GloboMailerApi_ParamsIterator implements Iterator
{
	/**
