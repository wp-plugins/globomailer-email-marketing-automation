<?php
$gmema_plugin_name='Globomailer Email Marketing Automation';
...
if(!defined('GMEMA_PLUGIN_DISPLAY')) define('GMEMA_PLUGIN_DISPLAY', "Globomailer Email Marketing Automation");
...
if(!defined('GMEMA_URL')) define('GMEMA_URL',plugins_url().'/'.'globomailer-email-marketing-automation'.'/');
define('GMEMA_FILE',GMEMA_DIR.'globomailer-email-marketing-automation.php');
