...
if (isset($_POST['gmema_form_submit']) && $_POST['gmema_form_submit'] == 'yes')
{
	...
	if ($gmema_error_found == FALSE)
	{
		...
		if ($response->itemAt('status') == 'success') {
		    $gmema_success = __('List was successfully added.', GMEMA_TDOMAIN);
		}else
		{
...
<div class="form-wrap">
	...
	<form name="form_addemail" method="post" action="#" onsubmit="return _gmema_addemail()"  >
      <h3 class="title"><?php _e('Add List', GMEMA_TDOMAIN); ?></h3>
      <table class="form-table">
      	<tbody>
      		...
      		<tr>
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_g_name" name="gmema_g_name">				
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_g_desc" name="gmema_g_desc">				
				</td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_d_fname" name="gmema_d_fname">				
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_d_femail" name="gmema_d_femail">				
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_d_replyto" name="gmema_d_replyto">				
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_d_subject" name="gmema_d_subject">				
				</td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_n_substo" name="gmema_n_substo">				
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_n_unsubsto" name="gmema_n_unsubsto">				
				</td>
			</tr>
			<tr>
				<td colspan="2">
			...
			<tr>
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_c_name" name="gmema_c_name">				
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_c_country" name="gmema_c_country">				
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_c_zone" name="gmema_c_zone">				
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_c_add1" name="gmema_c_add1">				
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_c_add2" name="gmema_c_add2">				
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_c_zonenm" name="gmema_c_zonenm">				
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_c_city" name="gmema_c_city">				
				</td>
			</tr>
			<tr>
				<th scope="row">
				...
				<td>
					<input type="text" maxlength="225" size="60" value="" id="gmema_c_zip" name="gmema_c_zip">				
				</td>
			</tr>
      	</tbody>
      </table>
