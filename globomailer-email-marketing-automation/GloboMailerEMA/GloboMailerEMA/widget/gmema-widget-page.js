		...
		if (http_req.status == 200) 
		{
			...
			{ 
				...
				if(response['status'] == "success")
				{
					...
					document.getElementById("gmema_txt_email_pg").value="";
					document.getElementById("gmema_txt_first_name_pg").value="";
					document.getElementById("gmema_txt_last_name_pg").value="";
				}
