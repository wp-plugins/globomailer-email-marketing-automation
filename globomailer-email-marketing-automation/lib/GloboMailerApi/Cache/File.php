<?php
/**
 * This file contains the File cache class used in the GloboMailerApi PHP-SDK.
 * 
...
/**
 * GloboMailerApi_Cache_File makes use of the file system in order to cache data.
 * 
 * @author Incite Minds Ltd <support@globosupport.com>
 ...
 * @since 1.0
 */
class GloboMailerApi_Cache_File extends GloboMailerApi_Cache_Abstract
{
    /**
     ...
     * @return GloboMailerApi_Cache_File
     */
